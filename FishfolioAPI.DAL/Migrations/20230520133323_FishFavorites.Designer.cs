...
namespace FishfolioAPI.DAL.Migrations
{
    ...
    [Migration("20230520133323_FishFavorites")]
    partial class FishFavorites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FishfolioAPI.Model.FavoriteFish", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FishfolioAPI.Model.FishFamilyIncompatibility", b =>
                {
                    ...
                    b.Property<int?>("IncompatibleId")
                        .HasColumnType("int");

                    b.HasKey("ParentId", "CompatibilityId");

                    b.HasIndex("IncompatibleId");
            ...
            modelBuilder.Entity("FishfolioAPI.Model.FavoriteFish", b =>
                {
                    b.HasOne("FishfolioAPI.Model.Fish", "Fish")
                        .WithMany()
                        .HasForeignKey("FishId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FishfolioAPI.Model.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("FishfolioAPI.Model.FishFamilyIncompatibility", b =>
                {
                    b.HasOne("FishfolioAPI.Model.FishFamily", "Incompatible")
                        .WithMany()
                        .HasForeignKey("IncompatibleId");
